...
$query="select * from waterbodies where $scope like '%$scopename%' and status = 'nomap'";
       ...
       <div class="site-content">
        <div class="panel panel-default panel-table">
          ...
          <div class="panel-body">
            <div class="table">
        <table   id="myyTable" class="table" style="width:100%">
           <thead>
                <tr>
     ...
     ?>
                <tr>
                        ...
                        <td><form action="shwmap.php" method="POST">
                            ...
                            <input type="hidden" name="lon" value="<?php echo $rows['lon'];?>">
                            <input type="hidden" name="type" value="<?php echo $rows['type'];?>">
                        <button class="btn btn-primary" type="submit">Map</button></form>

                    
                    </td>
                        <td><form action="chngstat.php" method="POST">
                            <input type="hidden" name="bid" value="<?php echo $rows[0];?>">
                        <button class="btn btn-primary" type="submit">Mapped / Removed</button></form>
                    </td>
