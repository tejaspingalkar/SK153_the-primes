...
if(isset($_COOKIE['lat']) and $_COOKIE['lon'])
{
  $lat = $_COOKIE['lat'];
  $lon = $_COOKIE['lon'];
  echo '<script language="javascript">';
  //echo 'alert("all set");';
  echo '</script>';
  $query = "UPDATE registercomplaint SET lat = '$lat',lon='$lon' WHERE compl_id = '$id'";
...
<a class="temp" href='#openModal'></a>
        <div onload="load()" id="openModal" class="modalDialog">
            <div>
                ...
                <h2>Tips</h2>
                <h4>Turn On Location(Geotagging) Feature in Your Camera Setting. For
                  Better review 
                </h4>
                  </div>
        </div>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header" style="padding:15px 50px;">
          ...
          <h4 style="text-align: center;">Finally Rate The Embankment</h4>
        </div>
