...
$q="select * from embankment where river like '%$river%' and state like '%$state%' and village like '%$city%' and status = '1'";
$res=mysqli_query($conn,$q);

$qe="select * from embankment where river like '%$river%' and state like '%$state%' and village like '%$city%' and status = '1'";
$res1=mysqli_query($conn,$qe);

$q5="select * from embankment where river like '%%' and state like '%%' and village like '%%' and status = '1'";
...
$q6="select DISTINCT village from embankment where status = '1'";
    ...
    <div class="site-content">
        ...
        <div class="col-sm-12">
            ...
            <div class="text-center">
              <form class="form-inline" action="seeembank.php" method="POST">
                  ...
                  <div class="input-group">
                    ...
                    <input list="city" name="city" class="form-control"  placeholder="Select City">
                        <datalist id="city" >
                            <option value="" selected>
                              <?php
                                   while ($rowss3=mysqli_fetch_array($res6))
                                   {
                                    echo "<option value ='".$rowss3['village']."'>";
                                   }
                                ?>
...
function initialize() {
    ...
    var infoWindowContent = [
        <?php while($row6=mysqli_fetch_array($res5)){?>
           
        [
       
        '<div class="card " style="width: 350px;"> <img src="<?php echo $row6[10] ?>"  alt="..." style = "height:250px; width:350px;"> <div class="card-body"> <h3 class="card-title"><?php echo $row6[1];?>\'s Embankment</h3> <p class="card-text">Some quick example text to build on the card title and make up the bulk of the cards content.</p> <form action = "embankinfo.php" method="POST"> <input type="hidden" name= "eid" value = "<?php echo $row6[0];?>"> <input type="submit" class="btn btn-primary btn-lg btn-block" value="View"></form>  </div> </div>'        
       ],
        <?php }?>
    ];  
